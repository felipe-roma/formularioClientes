...
<body>
    ...
    <section>
        <div align="center">
            <form class="d-flex p-3 w-50" role="search" method="POST" action="vendedor.php">
                        ...
                        try {
                            ...
                            if ($st->execute()) {
                                while ($rs = $st->fetch(PDO::FETCH_OBJ)) {
                                    echo "<option value='" . $rs->id . "'>" . $rs->nome_vendedor . " (" . $rs->codigo . ")</option>";
                                }
                            }
