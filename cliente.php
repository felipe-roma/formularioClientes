...
<body>
    ...
    <section>
        <div align="center">
            <form class="d-flex p-3 w-75" role="search" method="POST" action="cliente.php">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Cliente</span>
                    <input class="form-control" type="search" placeholder="Pesquisar..." aria-label="Search" name="nome_cliente" required>
